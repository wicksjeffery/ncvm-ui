...
UI::Windows::Information::Information(int height, int width, int begin_y, int begin_x)
    :
        Rectangle(height, width, begin_y, begin_x)
{
    ...
    mvwaddch(m_window, height-3, 5, ACS_RARROW | A_BLINK);
    mvwprintw(m_window, height-3, 7, "Created by Jeff A. Wicks in Cleveland Ohio - 2025");
